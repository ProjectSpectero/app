module.exports = {
  ...
  misc: {
    ...
    GO_TO_NODES_LIST: 'Back to your nodes',
    NO_CANCEL: 'No, Cancel',
  ...
  errors: {
    ...
    DAEMON_ERROR_TEXT: 'We were unable to connect to this node. Please try again and contact us if the problem persists.',
  ...
  daemon: {
    ...
    REQUEST_FAILED: 'We were unable to communicate with that node. Please try again later and contact us if the problem persists.',
    ...
    SERVICES: 'Services',
    PROXIES: 'Proxies',
    USER_UPDATE_ERROR: 'We were unable to save at this time. Please fix any errors and try again.',
